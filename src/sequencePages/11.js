  ...
  return (
    <div className="p-10">
      <div className="flex flex-col float-end">
        ...
        <div className="text-2xl"> Past Tenseee</div>
      ...
      <div className="flex flex-col justify-center h-[100vh] -mt-20">
        ...
        <div className="text-xl pb-2">It is 12:00 p.m in the AFTERNOON.</div>
        <div className="pb-2">
          <p className="text-xl">Q: Who have you met with?</p>
          <p className="text-lg">
            A: I have met with the{" "}
            {characters[1].Name.replace(" ", "").toUpperCase()}.
          </p>
        </div>
        <div className="pb-2">
      ...
      <Link to={`/12`}>
        Okay, let's prepare to meet your {characters[characterId].Name}.
      </Link>
    </div>
  );
};
